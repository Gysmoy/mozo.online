  ...
  <div id="wrapper">
      ...
      <div class="inner">
        ...
        <section id="banner">
          ...
          <span class="image object" style="box-shadow: 0 0 10px grey;">
            <iframe id="pageIframe" src="" frameborder="0" width="100%" height="100%"></iframe>
          </span>
        </section>
    ...
    <div id="sidebar">
      <div class="inner">
        ...
        <!-- Footer -->
        <footer id="footer">
          <p class="copyright">&copy; Mozo en línea | Versión 1.0.0 | Powered by: <a href="http://gysmoy.epizy.com">Gysmoy & Kizzi</a></p>
        </footer>
